...
export const testController = {
  seedData: async (req, res) => {
    try {
      ...
      // Scenario 4: Captured + Settlement Pending
      ...
      // Scenario 6: Customer Debited + Settlement Pending
      ...
      // Scenario 7: Repeated Payment Failures
      ...
      const txn9 = await prisma.transaction.create({
        data: {
          id: 'TXN_10009',
          providerPaymentId: 'pay_TEST10009',
          merchantId: merchant.id,
          customerId: customerD.id,
          amount: 250000,
          currency: 'INR',
      ...
      // Scenario 10: Recovery Escalated to Human
      const txn10 = await prisma.transaction.create({
        data: {
          id: 'TXN_10010',
          providerPaymentId: 'pay_TEST10010',
          merchantId: merchant.id,
          customerId: customerE.id,
          amount: 12000000,
          currency: 'INR',
